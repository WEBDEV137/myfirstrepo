...
INSERT INTO vraag
VALUES(DEFAULT, 'Wat is een database?',1),
(DEFAULT, 'Hoevvraageel regels code mag 1 stuk bevatten?',1),
(DEFAULT, 'Welke tool kan je gebruiken om samen aan software te werken?', 1),
(DEFAULT, 'Wat is beter?',1),
(DEFAULT, 'Wat is data?',2),
(DEFAULT, 'Hoe lang is een Chinees?', 2),
(DEFAULT, 'Juist of onjuist?', 2),
(DEFAULT, 'Wat zijn software requirements?', 2),
(DEFAULT, 'Hoeveel regels code mag 1 stuk bevatten?',3),
(DEFAULT, 'Wat doet Maven?', 3),
(DEFAULT, 'Wat is een soort database',3),
(DEFAULT, 'Wat is big data?',3),
(DEFAULT, 'Wat is een ArrayList', 4),
(DEFAULT, 'Juist, onjuist, of beide?', 4),
(DEFAULT, 'Wat zijn software requirements niet?', 4),
(DEFAULT, 'Wat is een for-loop?', 4),
